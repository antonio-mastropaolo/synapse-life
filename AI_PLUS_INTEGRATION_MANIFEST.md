...
This file is the contract between agent 5 (AI++ wedge) and the macOS / iOS app shells. Every surface listed below is built and tested inside `SynnapseKit/Features`; the manifest tells the app layer where each surface needs to live in the navigation graph.
