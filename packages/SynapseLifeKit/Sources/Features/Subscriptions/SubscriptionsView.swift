    ...
    private func cancelSheet(merchant: String, tokens: TokenSet) -> some View {
        VStack(alignment: .leading, spacing: 14) {
            Text("Cancel \(merchant)")
                ...
                .foregroundStyle(tokens.foregroundPrimary.color)
            Text("Visit \(merchant)'s account page to cancel. Synapse can't cancel subscriptions on your behalf — but it can remind you the day before the next charge lands.")
