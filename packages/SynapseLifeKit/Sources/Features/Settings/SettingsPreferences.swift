...
public enum SettingsKey: String, CaseIterable {
    case apiBaseURL = "synapse.settings.apiBaseURL"
    case concealBalances = "synapse.settings.concealBalances"
    case reduceMotionPreview = "synapse.settings.reduceMotionPreview"
    case aiModel = "synapse.settings.aiModel"
    case aiOnDeviceTranscription = "synapse.settings.aiOnDeviceTranscription"
    case aiInsightsDigest = "synapse.settings.aiInsightsDigest"
    case aiAnomalySensitivity = "synapse.settings.aiAnomalySensitivity"
}
